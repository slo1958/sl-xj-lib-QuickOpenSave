...
You replace all calls to folderItem.ShowOpenDialog()  with calls to fldShowOpenDialog(). The behaviour of your application does not change, since by default this methods calls FolderItem.ShowOpenDialog()
...
History is used for ShowOpenDialog() and ShowSaveDialog(). It takes precedence on TestMode.
